...
class WingSegmentationExperiment(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val_loss", val_loss, batch_size=images.size(0))
...
class SegmentationData(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return torch.utils.data.DataLoader(train_dataset, batch_size=8, shuffle=False, num_workers=0)
    ...
    def val_dataloader(self):
        ...
        return torch.utils.data.DataLoader(val_dataset, batch_size=8, shuffle=False, num_workers=0)
...
class PredictSegmentationData(pl.LightningDataModule):
    ...
    def predict_dataloader(self):
        ...
        return torch.utils.data.DataLoader(prediction_dataset, batch_size=8, shuffle=False, num_workers=0)
